                ...
                onClick = {
                    if (statePassword == stateConfirmPassword) {
                        db.collection("authorized_users")
                            .whereEqualTo("email", stateEmail)
                            .get()
                            .addOnSuccessListener { documents ->
                                if (documents.isEmpty) {
                                    Toast.makeText(activity, "Usuario no autorizado para registrarse", Toast.LENGTH_SHORT).show()
                                } else {
                            ...
                            .addOnFailureListener {
                                Toast.makeText(activity, "Error al verificar usuario", Toast.LENGTH_SHORT).show()
                            }
                    }else{
